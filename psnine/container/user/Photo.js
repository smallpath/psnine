...
class Item extends React.PureComponent {
  ...
  render() {
    const { modeInfo, rowData, index, onLongPress, navigation, onPress } = this.props
    ...
    return (
      <View key={rowData.id || index} style={{
        ...
        >
          <View style={{ flex: 1, flexDirection: 'row', padding: 5, width: 160, height: 160 }}>
            {
                    ...
                    <View style={{
                      ...
                      {/*{ onLongPress && (
                        <TouchableNativeFeedback onPress={() => {
                          ...
                          <View style={{height: 50, paddingVertical: 10, paddingLeft: 20 ,alignSelf: 'stretch', alignContent: 'stretch', justifyContent: 'center'}}>
                            <Text style={{textAlignVertical: 'center', fontSize: 18, color: modeInfo.standardTextColor}}>引用</Text>
                          </View>
                        </TouchableNativeFeedback>
                        )
                      }*/}
